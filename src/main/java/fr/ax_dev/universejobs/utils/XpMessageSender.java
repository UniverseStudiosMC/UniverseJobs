...
public class XpMessageSender {
     ...
     */
    public void sendXpMessage(Player player, Job job, double xp, fr.ax_dev.universejobs.job.PlayerJobData playerData) {
     ...
     * @param playerData The player's job data (for progress calculation)
     */
    public void sendXpMessage(Player player, Job job, double xp, double money, fr.ax_dev.universejobs.job.PlayerJobData playerData) {
     ...
     */
    private void sendBossBarMessage(Player player, String message, XpMessageSettings settings, Job job, fr.ax_dev.universejobs.job.PlayerJobData playerData) {
        try {
            UUID playerId = player.getUniqueId();
     ...
     */
    private double calculateXpProgress(String jobId, fr.ax_dev.universejobs.job.PlayerJobData playerData) {
        try {
     ...
     */
    private void sendCustomBossBarMessage(Player player, String message, MessageConfig messageConfig) {
        try {
            UUID playerId = player.getUniqueId();
