...
public class LanguageManager {
    ...
    public LanguageManager(JobsAdventure plugin) {
        this.plugin = plugin;
        this.languageFiles = new HashMap<>();
        this.currentLocale = "en_US"; // Default locale
    ...
    public void loadLanguageFiles() {
        ...
        if (!languageFiles.containsKey("en_US")) {
            ...
            languageFiles.put("en_US", new YamlConfiguration());
        }
    }
    ...
    public void loadLanguage() {
        this.currentLocale = plugin.getConfig().getString("language.locale", "en_US");
        
        loadLanguageFiles();
        
        this.currentLanguage = languageFiles.get(currentLocale);
        this.fallbackLanguage = languageFiles.get("en_US");
    ...
    private String getRawMessage(String key) {
        ...
        if (message == null && fallbackLanguage != null && !currentLocale.equals("en_US")) {
