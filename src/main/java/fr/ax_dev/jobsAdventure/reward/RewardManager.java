...
import fr.ax_dev.jobsAdventure.reward.gui.GuiConfig;
import fr.ax_dev.jobsAdventure.reward.gui.GuiConfigLoader;
import fr.ax_dev.jobsAdventure.reward.gui.ItemBuilder;
import fr.ax_dev.jobsAdventure.reward.storage.FileRewardStorage;
import fr.ax_dev.jobsAdventure.reward.storage.RewardStorage;
...
public class RewardManager {
     ...
     */
    public RewardManager(JobsAdventure plugin) {
        this.plugin = plugin;
